...
function DiemNgayYeu() {
   ...
   // var ngaykiniem = 365 - Math.floor(khoangthoigian / (1000 * 60 * 60 * 24));
    ...
    var gio = Math.floor((khoangthoigian % (1000 * 60 * 60 * 24)) / (1000 * 60 * 60));
    var phut = Math.floor((khoangthoigian % (1000 * 60 * 60)) / (1000 * 60));
  ...
  function DiemNguocNoel() {
    ...
    var ngay = Math.floor(khoangthoigian / (1000 * 60 * 60 * 24));
    var showdaynoel = document.getElementById("ngay-noel");
    showdaynoel.innerHTML = "Điếm ngược " + ngay + " ngày nữa đến lễ Noel";
}
  function StartMedia() {
    ...
    video.play();
    audio.play();
    var container = document.getElementById("start-noel");
    ...
    function ChangeVideo() {
        var video = document.getElementById("video1");
        video.src = "./_static/render/noel-1.mp4";
        video.play();
    }
    function StartFullScreen() {
        var elem = document.documentElement;
        var CheckMobiles = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent);
